// =============================================================================
// agent_team.ts — 主版本 Agent 团队管理器（与 examples/step09/agent_team.ts 等价）
// -----------------------------------------------------------------------------
// 这一份对应 src/agent_team.rs，能力相当于 step09：在 step08 把 agent 做成 runtime
// 里可以并发跑的“后台 worker”的基础上，加上“角色 / 父子关系 / 深度”三件套：
//
