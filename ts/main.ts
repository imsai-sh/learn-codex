// =============================================================================
// main.ts — 合并版主入口（等价于 step05 + step06 + step07 + step08 + step09）
// -----------------------------------------------------------------------------
// 这就是项目根目录下 src/main.rs 的 TypeScript 等价实现，能力上相当于把 step09
// 拿出来作为最终版本：
...
//
// 关键点（来自 step09）：把 ToolExecutionContext.root() 塞进每个顶层
