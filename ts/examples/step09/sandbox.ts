// =============================================================================
// step09 / sandbox.ts — 在 step08 之上加入“执行上下文”和“父子关系”
// -----------------------------------------------------------------------------
// step08 让 agent 成了 runtime 里可以并发跑的后台 worker，但所有 agent 都是
// 同质的，工具调用只看 "tool name + arguments"。step09 引入了
// **ToolExecutionContext**：每一次工具调用都带着“是谁在调用”的元数据：
//
