// =============================================================================
// step07 / step07.ts — 主循环和 step06 完全一致
// -----------------------------------------------------------------------------
// step07 的真正改动是在 agent_team.ts 引入了 AgentThread / AgentTeamManager；
// 不过这一阶段还没有把它们绑定为可被模型直接调用的工具（spawn_agent 等是 step08
// 才会出现）。本文件保留 step06 的主循环结构，仅作为承上启下。
// =============================================================================
